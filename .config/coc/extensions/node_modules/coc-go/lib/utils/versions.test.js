...
describe("parseVersion()", () => {
    it("should parse simple versions", () => {
        assert_1.default.deepStrictEqual((0, versions_1.parseVersion)('v0.0.0'), v0);
        assert_1.default.deepStrictEqual((0, versions_1.parseVersion)('v1.0.0'), v1);
        assert_1.default.deepStrictEqual((0, versions_1.parseVersion)('v1.2.0'), v1_2);
