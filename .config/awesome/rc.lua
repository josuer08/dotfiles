...
local scrlocker    = "slock systemctl suspend" --This is in order to lock and suspend in one command
...
--awful.spawn.with_shell("/home/josuer08/.screenlayout/ontop.sh")
